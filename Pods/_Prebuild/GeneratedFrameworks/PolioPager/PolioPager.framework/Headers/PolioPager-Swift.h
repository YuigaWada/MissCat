...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PolioPager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PolioPager18PageViewController")
...
@interface PageViewController (SWIFT_EXTENSION(PolioPager)) <UIPageViewControllerDelegate>
...
@interface PageViewController (SWIFT_EXTENSION(PolioPager)) <UIPageViewControllerDataSource>
...
SWIFT_CLASS("_TtC10PolioPager24PolioPagerViewController")
@interface PolioPagerViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified collectionView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified searchBar;
...
@interface PolioPagerViewController (SWIFT_EXTENSION(PolioPager)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
