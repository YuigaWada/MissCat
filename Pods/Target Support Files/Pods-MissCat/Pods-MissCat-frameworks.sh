...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/Differentiator/Differentiator.framework"
  install_dsym "${PODS_ROOT}/Differentiator/Differentiator.framework.dSYM"
  install_framework "${PODS_ROOT}/FloatingPanel/FloatingPanel.framework"
  install_dsym "${PODS_ROOT}/FloatingPanel/FloatingPanel.framework.dSYM"
  install_framework "${PODS_ROOT}/Gifu/Gifu.framework"
  install_dsym "${PODS_ROOT}/Gifu/Gifu.framework.dSYM"
  install_framework "${BUILT_PRODUCTS_DIR}/MisskeyKit/MisskeyKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PolioPager/PolioPager.framework"
  install_framework "${PODS_ROOT}/RxCocoa/RxCocoa.framework"
  install_dsym "${PODS_ROOT}/RxCocoa/RxCocoa.framework.dSYM"
  install_framework "${PODS_ROOT}/RxDataSources/RxDataSources.framework"
  install_dsym "${PODS_ROOT}/RxDataSources/RxDataSources.framework.dSYM"
  install_framework "${PODS_ROOT}/RxRelay/RxRelay.framework"
  install_dsym "${PODS_ROOT}/RxRelay/RxRelay.framework.dSYM"
  install_framework "${PODS_ROOT}/RxSwift/RxSwift.framework"
  install_dsym "${PODS_ROOT}/RxSwift/RxSwift.framework.dSYM"
  install_framework "${PODS_ROOT}/SVGKit/SVGKit.framework"
  install_dsym "${PODS_ROOT}/SVGKit/SVGKit.framework.dSYM"
  install_framework "${PODS_ROOT}/SkeletonView/SkeletonView.framework"
  install_dsym "${PODS_ROOT}/SkeletonView/SkeletonView.framework.dSYM"
  ...
  install_framework "${PODS_ROOT}/XLPagerTabStrip/XLPagerTabStrip.framework"
  install_dsym "${PODS_ROOT}/XLPagerTabStrip/XLPagerTabStrip.framework.dSYM"
