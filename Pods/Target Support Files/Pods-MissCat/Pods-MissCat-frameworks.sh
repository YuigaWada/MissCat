...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/MisskeyKit/MisskeyKit.framework"
  install_dsym "${PODS_ROOT}/MisskeyKit/MisskeyKit.framework.dSYM"
  install_framework "${PODS_ROOT}/PolioPager/PolioPager.framework"
  install_dsym "${PODS_ROOT}/PolioPager/PolioPager.framework.dSYM"
  ...
  install_framework "${PODS_ROOT}/Starscream/Starscream.framework"
  install_dsym "${PODS_ROOT}/Starscream/Starscream.framework.dSYM"
